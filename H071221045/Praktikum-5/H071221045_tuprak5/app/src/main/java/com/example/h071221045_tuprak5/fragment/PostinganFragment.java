package com.example.h071221045_tuprak5.fragment;
...
import com.example.h071221045_tuprak5.Instagram;
import com.example.h071221045_tuprak5.R;
...
public class PostinganFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_posting.setOnClickListener(btn ->{
            ...
            if (konten.isEmpty()) {
                Toast.makeText(getActivity(), "Isilah Konten Terlebih Dahulu", Toast.LENGTH_SHORT).show();
            } else if (selectedImageUri != null) {
                Instagram instagram = new Instagram("Henokh Abhinaya Tjahjadi", "Henokh", konten, R.drawable.upload, selectedImageUri);
                ...
                Toast.makeText(getActivity(), "Pilihlah Gambar Terlebih Dahulu", Toast.LENGTH_SHORT).show();
            }
        });
