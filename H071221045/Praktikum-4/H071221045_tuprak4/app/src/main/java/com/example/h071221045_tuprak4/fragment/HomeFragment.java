package com.example.h071221045_tuprak4.fragment;
...
import com.example.h071221045_tuprak4.DataSource;
import com.example.h071221045_tuprak4.Instagram;
import com.example.h071221045_tuprak4.PostinganAdapter;
import com.example.h071221045_tuprak4.R;
...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        PostinganAdapter postinganAdapter = new PostinganAdapter(DataSource.accounts);
        ...
        if (bundle != null) {
            ...
            if (instagram != null) {
                DataSource.accounts.add(0, instagram);
